...
by  C.J. Forman & M.J.Y. Zimmermann, 2018.12.11
...
const int POT_VALUE_HIGH = 1023; // Highest value available from the potentiometer (measured value). Can make this higher by reducing resistor value in series with pot, but goes below 125 Ohms and current will exceed 40 mA max on Analog pin.
