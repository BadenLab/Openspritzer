...
pos_x_Platform1 = -x_Box/2 + TOL + r_Platform + 20;
pos_x_Platform2 = -x_Box/2 + TOL + r_Platform + 50;
pos_y_Platform1 = -y_Box/2 + TOL + r_Platform + 52;
pos_y_Platform2 = -y_Box/2 + TOL + 2*Wall + 19;
...
module Logo(){
    translate([x_Box/2+2.5,-20,z_Box-Wall/2])rotate([0,0,90])scale([0.75,0.75,1])scale([0.175,0.175,1])import("C:/Users/Maxime/Desktop/Badenlab_logo.stl");
}
module Title(){
    translate([-15,-x_Box/2-5,z_Box-Wall/2])linear_extrude(h=Wall/2)rotate([0,0,90])text("OpenSpritzer");
    translate([-15,40,z_Box-Wall/2])linear_extrude(h=Wall/2)rotate([0,0,90])text("v1.2",size=5);
...
module Labels(){
    translate([6.5,-y_Box/2+Wall,z_Box/2+2])rotate([90,0,0])linear_extrude(h=Wall/2)text("Foot Pedal",size=3);
    translate([-18.5,-y_Box/2+Wall,z_Box/2+2])rotate([90,0,0])linear_extrude(h=Wall/2)text("TTL",size=3);
    translate([-x_Box/2+42.5,-y_Box/2+Wall,z_Box/2+18])rotate([90,0,0])linear_extrude(h=Wall/2)text("Air out",size=3);
    
    translate([x_Box/2+3*Wall,-y_Box/2+35,z_Box/2+2])rotate([90,0,0])rotate([0,90,0])linear_extrude(h=Wall/2)text("Pulse Duration",size=3);
    ...
    translate([-x_Box/2+Wall,8.5,z_Box/2+3])rotate([90,0,-90])linear_extrude(h=Wall/2)text("Power in",size=3);
    translate([-x_Box/2+Wall,4,z_Box/2+-0.5])rotate([90,0,-90])linear_extrude(h=Wall/2)text("24V",size=3);
}
